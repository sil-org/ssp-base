...
$metadata['ssp-hub.local'] = [
    ...
    'name' => ['en' => 'ssp-hub.local'],
    'IDPNamespace' => 'ssp-hub',
    'logoCaption' => 'SSP Hub',
    'logoURL' => 'https://dummyimage.com/125x125/0f4fbd/ffffff.png&text=SSP+HUB',
    'SingleSignOnService' => [
        [
    ...
    'SingleLogoutService' => [
        [
            'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
            'Location' => 'http://ssp-hub.local/saml2/idp/SingleLogoutService.php',
        ],
    ],
