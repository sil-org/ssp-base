...
$metadata['ssp-hub.local'] = [
    ...
    'AssertionConsumerService' => [
        [
            ...
            'Location' => 'http://ssp-hub.local/module.php/saml/sp/saml2-acs.php/hub-discovery',
        ],
    ],
    'SingleLogoutService' => [
        [
            'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
            'Location' => 'http://ssp-hub.local/module.php/saml/sp/saml2-logout.php/hub-discovery',
        ],
    ],
